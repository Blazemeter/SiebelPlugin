...
public class SiebelRowExtractorTest {
  ...
  private SiebelContext context;
  private SiebelRowExtractor siebelRowExtractor;
  ...
  public void shouldAddRegexExtractorAndPostProcessorWhenRegexOneMatches() {
    ...
    siebelRowExtractor = new SiebelRowExtractor(REGEX_ONE, context);
    ...
    JSR223PostProcessor jSR223PostProcessor = createPostProcessor(REFERENCE_NAME);
  ...
  public void shouldAddRegexExtractorAndPostProcessorWhenRegexTwoMatches() {
    ...
    siebelRowExtractor = new SiebelRowExtractor(REGEX_TWO, context);
    siebelRowExtractor.setVariableName(REFERENCE_NAME);
    siebelRowExtractor.process(sampler, children, sampleResult, vars);
  ...
  private JSR223PostProcessor createPostProcessor(String variableName) {
    ...
    String varNamePrefix = variableName + "0";
