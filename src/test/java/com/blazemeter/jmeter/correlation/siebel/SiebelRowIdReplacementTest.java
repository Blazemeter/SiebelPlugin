...
public class SiebelRowIdReplacementTest {
  ...
  private SiebelRowIdReplacement siebelRowIdReplacement;
  private SiebelContext siebelContext = new SiebelContext();
  
  @Before
  public void setup() {
    vars = new JMeterVariables();
    siebelRowIdReplacement = new SiebelRowIdReplacement(REGEX_THAT_MATCHES, siebelContext);
  }
  ...
  public void shouldReplaceInputStringWhenRegexMatches() throws MalformedPatternException {
    ...
    String replacedString = siebelRowIdReplacement.replaceWithRegex(INPUT_STRING, REGEX_THAT_MATCHES, VARIABLE_NAME, vars);
    assertThat(replacedString).isEqualTo(expectedString);
  }

  @Test
  public void shouldNotReplaceInputStringWhenRegexMatchesButThereIsNoAJMeterVar() throws MalformedPatternException {
    siebelContext.addRowVar(ROW_ID, VARIABLE_NAME);
  ...
  public void shouldNotReplaceInputStringWhenRegexDoesNotMatch() throws MalformedPatternException {
    ...
    vars.put(VARIABLE_NAME + "_rowId", ROW_ID);
    String expectedString = "SWERowId=" + ROW_ID;
    String replacedString = siebelRowIdReplacement.replaceWithRegex(INPUT_STRING, REGEX_THAT_DOES_NOT_MATCH, VARIABLE_NAME, vars);
    assertThat(replacedString).isEqualTo(expectedString);
  }
  
  @Test
  public void shouldNotReplaceInputStringWhenRegexMatchesButRowVarIsNotInContext() throws MalformedPatternException {
  ...
  @Test
  public void shouldNotReplaceInputStringWhenRegexMatchesButContextDoesNotContainAnyVar() throws MalformedPatternException {
    vars.put(VARIABLE_NAME + "_rowId", ROW_ID);
    String expectedString = "SWERowId=" + ROW_ID;
    String replacedString = siebelRowIdReplacement.replaceWithRegex(INPUT_STRING, REGEX_THAT_DOES_NOT_MATCH, VARIABLE_NAME, vars);
    assertThat(replacedString).isEqualTo(expectedString);
