...
public class SiebelArrayFunctionTest {
  ...
  public void shouldCreateTheExpectedJMeterVariableVarOne() {
    ...
    assertThat(vars.get("testVariable_1").equals(EXPECTED_VAR_ONE));
  }

  @Test
  public void shouldCreateTheExpectedJMeterVariableVarTwo() {
    SiebelArrayFunction.split(STRING_TO_SPLIT_STAR_ARRAY, VAR_NAME_PREFIX, vars);
    assertThat(vars.get("testVariable_2").equals(EXPECTED_VAR_TWO));
  }

  @Test
  public void shouldCreateTheExpectedJMeterVariableVarThree() {
    SiebelArrayFunction.split(STRING_TO_SPLIT_STAR_ARRAY, VAR_NAME_PREFIX, vars);
    assertThat(vars.get("testVariable_3").equals(EXPECTED_VAR_THREE));
  }

  @Test
  public void shouldCreateTheExpectedJMeterVariableWhichAssigTheNumberOfVariables() {
    SiebelArrayFunction.split(STRING_TO_SPLIT_STAR_ARRAY, VAR_NAME_PREFIX, vars);
    assertThat(vars.get("testVariable_n").equals(EXPECTED_NUMBER_OF_MATCHES));
  }

  @Test
  public void shouldThrowExpectedExceptionWhenInputStringIsNotAStarArrayString() throws Exception {
  ...
  @Test
  public void shouldThrowExpectedExceptionWhenInputStringIsNull() throws Exception {
    expectedException.expect(IllegalArgumentException.class);
    SiebelArrayFunction.split(null, VAR_NAME_PREFIX, vars);
  }

  @Test
  public void shouldThrowExpectedExceptionMessageWhenInputStringIsNull() throws Exception {
    expectedException.expectMessage("Input string cannot be null.");
    SiebelArrayFunction.split(null, VAR_NAME_PREFIX, vars);
  }

  @Test
  public void validateWheatherNoJMeterVariablesAreCreatedWhenInputStringIsNotAStarArrayString() {
    try {
      SiebelArrayFunction.split(STRING_TO_SPLIT_NOT_STAR_ARRAY, VAR_NAME_PREFIX, vars);
    } catch (Exception e) {
    }
  ...
  @Test
  public void validateWheatherNoJMeterVariablesAreCreatedWhenInputStringIsNull() {
    try {
      SiebelArrayFunction.split(null, VAR_NAME_PREFIX, vars);
    } catch (Exception e) {
    }
