...
public class FunctionReplacementTest {
  ...
  private FunctionReplacement replacer;
  ...
  public void setup() {
    ...
    replacer = new FunctionReplacement(REQUEST_REGEX);
  ...
  public void shouldReplaceHeaderManagerValueWhenRegexMatches() {
    replacer = new FunctionReplacement("(" + PARAM_VALUE + ")");
    replacer.setVariableName(REFERENCE_NAME);
