...
public class RegexMatcherTest {
  ...
  public void findMatchShouldReturnTheExpectedMatchWhenRegexMatches() {
    RegexMatcher regexMatcher = new RegexMatcher(INPUT_STRING_ONE, REGEX_MATCHES, REGEX_GROUP);
    assertThat(regexMatcher.findMatch(1)).isEqualTo(EXPECTED_FIRST_MATCH);
  }

  @Test
  public void findMatchShouldReturnNullWhenRegexMatchesButGroupNumberIsNotFound() {
    RegexMatcher regexMatcher = new RegexMatcher(INPUT_STRING_ONE, REGEX_MATCHES, REGEX_GROUP);
    assertThat(regexMatcher.findMatch(3)).isNull();
  }

  @Test
  public void findMatchShouldReturnNullWhenGoupNumberIsLessThanZero() {
    RegexMatcher regexMatcher = new RegexMatcher(INPUT_STRING_ONE, REGEX_MATCHES, REGEX_GROUP);
    assertThat(regexMatcher.findMatch(-1)).isNull();
  }

  @Test
  public void findMatchShouldReturnNullWhenRegexDoesNotMatch() {
    RegexMatcher regexMatcher = new RegexMatcher(INPUT_STRING_ONE, REGEX_DOES_NOT_MATCH,
        REGEX_GROUP);
    assertThat(regexMatcher.findMatch(1)).isNull();
  }
  ...
  public void findMatchesShouldReturnTheExpectedMatchesWhenRegexMatchesMultipleTimes() {
    ...
    assertThat(regexMatcher.findMatches()).isEqualTo(matches);
  }

  @Test
  public void findMatchesShouldReturnASingleMatchIfItOnlyMatchesOnce() {
    RegexMatcher regexMatcher = new RegexMatcher(INPUT_STRING_TWO, REGEX_MATCHES, REGEX_GROUP);
    ArrayList<String> matches = new ArrayList<String>();
    matches.add(EXPECTED_FIRST_MATCH);
    assertThat(regexMatcher.findMatches()).isEqualTo(matches);
  }
  ...
  public void findMatchesShouldReturnNullWhenRegexDoesNotMatch() {
    RegexMatcher regexMatcher = new RegexMatcher(INPUT_STRING_TWO, REGEX_DOES_NOT_MATCH,
        REGEX_GROUP);
    assertThat(regexMatcher.findMatches()).isEqualTo(Collections.emptyList());
  }
}
